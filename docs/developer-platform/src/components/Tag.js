...
const colorStyles = {
    blue: {
        ...
        medium: "ring-blue-300 dark:ring-blue-400/30 bg-blue-400/10 text-blue-500 dark:text-blue-400",
    },
    sky: {
        small: "text-sky-500",
...
function Tag({ children, variant = "medium", color = valueColorMap[children] ?? "blue", }) {
    return (<span className={(0, clsx_1.default)("font-mono text-[0.625rem] font-semibold leading-6", variantStyles[variant], colorStyles[color][variant])}>
      {children}
    </span>);
}
