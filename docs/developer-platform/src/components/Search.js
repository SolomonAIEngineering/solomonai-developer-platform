...
const react_highlight_words_1 = __importDefault(
...
function useAutocomplete({ close }) {
  ...
  let [autocomplete] = (0, react_2.useState)(() =>
    (0, autocomplete_core_1.createAutocomplete)({
      id,
...
function HighlightQuery({ text, query }) {
  return (
    <react_highlight_words_1.default
...
function SearchResult({
  ...
  let id = (0, react_2.useId)();
  let sectionTitle = Navigation_1.navigation.find((section) =>
      ...
      {hierarchy.length > 0 && (
        ...
        >
          {hierarchy.map((item, itemIndex, items) => (
            <react_2.Fragment key={itemIndex}>
...
const SearchInput = (0, react_2.forwardRef)(function SearchInput(
...
function SearchDialog({ open, setOpen, className }) {
  ...
  return (
    ...
    >
      <react_1.Dialog
        onClose={setOpen}
        className={(0, clsx_1.default)("fixed inset-0 z-50", className)}
      >
