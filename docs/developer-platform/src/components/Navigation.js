...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {tag && (
        <Tag_1.Tag variant="small" color="zinc">
          {tag}
        </Tag_1.Tag>
      )}
    </link_1.default>
...
function NavigationGroup({ group, className }) {
  ...
  return (
    <li className={(0, clsx_1.default)("relative mt-6", className)}>
  ...
  return (
    <nav {...props}>
      <ul role="list">
        ...
        {exports.navigation.map((group, groupIndex) => (
          <NavigationGroup
            key={group.title}
            group={group}
