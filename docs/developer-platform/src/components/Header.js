...
exports.Header = (0, react_1.forwardRef)(function Header({ className }, ref) {
  let { isOpen: mobileNavIsOpen } = (0,
  MobileNavigation_1.useMobileNavigationStore)();
  let isInsideMobileNavigation = (0,
  MobileNavigation_1.useIsInsideMobileNavigation)();
  let { scrollY } = (0, framer_motion_1.useScroll)();
  let bgOpacityLight = (0, framer_motion_1.useTransform)(
    scrollY,
    [0, 72],
    [0.5, 0.9],
  );
  let bgOpacityDark = (0, framer_motion_1.useTransform)(
    scrollY,
    [0, 72],
    [0.2, 0.8],
  );
