...
exports.default = CallToActionSection;
...
const Card = (card) => {
    ...
    return (<framer_motion_1.motion.div key={id} ref={ref} initial={{ opacity: 0 }} animate={controls} className={(0, utils_1.cn)("relative size-20 cursor-pointer overflow-hidden rounded-2xl border p-4", 
        // light styles
          ...
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute z-10">
              <div className="mx-auto size-24 rounded-[2rem] border bg-white/10 p-3 shadow-2xl backdrop-blur-md dark:bg-black/10 lg:size-32">
                <lucide_react_1.HeartHandshake className="mx-auto size-16 text-black dark:text-white lg:size-24"/>
              </div>
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                ...
                <link_1.default href="#" className={(0, utils_1.cn)((0, button_1.buttonVariants)({
            size: "lg",
            variant: "outline",
        }), "group mt-4 rounded-[2rem] px-6")}>
                  Get Started
                  <lucide_react_1.ChevronRight className="ml-1 size-4 transition-all duration-300 ease-out group-hover:translate-x-1"/>
                </link_1.default>
              </div>
