...
import { apps, types } from "@v1/marketplace";
...
const categoryIcons = {
  ...
  [types.IntegrationCategory.Assistant]: (
    <HelpCircle className="w-5 h-5" strokeWidth={0.5} />
  ),
  [types.IntegrationCategory.Payroll]: (
    <Briefcase className="w-5 h-5" strokeWidth={0.5} />
  ),
  [types.IntegrationCategory.Banking]: (
    <Building2 className="w-5 h-5" strokeWidth={0.5} />
  ),
  [types.IntegrationCategory.CRM]: (
    <MessageSquare className="w-5 h-5" strokeWidth={0.5} />
  ),
  [types.IntegrationCategory.Notification]: (
    <Bell className="w-5 h-5" strokeWidth={0.5} />
  ),
};
