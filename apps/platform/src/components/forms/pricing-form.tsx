...
export default function Pricing({ user, products, subscription }: Props) {
  ...
  if (!products.length) {
    return (
      <section>
        <div className="flex-1 px-4 py-8 m-auto mx-auto sm:px-6 sm:py-24 lg:px-8">
    ...
    return (
      <Card>
        <div className="flex-1 px-4 py-8 m-auto mx-auto sm:px-6 sm:py-24 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-12 space-y-0 sm:mt-16 lg:mx-auto lg:max-w-4xl xl:mx-0 xl:max-w-none">
                ...
                >
                  <div className="p-6">
                    ...
                    <Button
                      ...
                      className="inline-flex items-center justify-center w-full h-10 px-6 py-2 mt-8 text-sm font-medium transition-colors rounded-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                    >
