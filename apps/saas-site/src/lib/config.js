...
exports.siteConfig = exports.BLUR_FADE_DELAY = void 0;
const icons_1 = require("@/components/icons");
const fa_1 = require("react-icons/fa");
const fa6_1 = require("react-icons/fa6");
const ri_1 = require("react-icons/ri");
exports.BLUR_FADE_DELAY = 0.15;
exports.siteConfig = {
    name: "startup.ai",
    ...
    header: [
        {
            ...
            content: {
                main: {
                    icon: <icons_1.Icons.logo className="h-6 w-6"/>,
        ...
        },
        {
            ...
            links: [
                ...
                },
                {
                    href: "#",
                    text: "Instagram",
                    icon: <ri_1.RiInstagramFill />,
                },
                {
                    href: "#",
                    text: "Youtube",
                    icon: <fa6_1.FaYoutube />,
                },
            ],
        },
    ],
