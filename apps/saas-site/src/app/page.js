...
const how_it_works_1 = __importDefault(
  require("@/components/sections/how-it-works"),
);
...
const testimonials_1 = __importDefault(
  require("@/components/sections/testimonials"),
);
const testimonials_carousel_1 = __importDefault(
  require("@/components/sections/testimonials-carousel"),
);
function Home() {
  return (
    <main>
