        ...
        <div className="flex w-full max-w-3xl flex-col gap-2">
          ...
          <div className="flex flex-col items-start justify-start gap-3 md:pt-[10%]">
            ...
            <p className="text-left text-gray-500">
              ...
              seasonal demands. Building on Midday's foundation, our platform
              harnesses the power of advanced machine learning to deliver
              intelligent seasonal forecasting, location-based market analysis,
              and automated cash flow management tailored to varying business
              cycles.
            </p>
            <p className="text-left text-gray-500">
              By democratizing access to enterprise-grade financial tools
              through an open-source approach, we're transforming how local
              businesses handle their financial operations. Our comprehensive
              suite includes real-time inventory optimization, foot traffic
              analysis, and customizable financial modeling that adapts to
              multiple business locations, enabling businesses to turn seasonal
              fluctuations into strategic advantages rather than operational
              challenges.
            </p>
          </div>
          <div className="flex flex-col items-start justify-start gap-3 md:pt-[10%]">
