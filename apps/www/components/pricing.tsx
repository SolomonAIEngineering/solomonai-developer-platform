        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-8 md:space-y-6 lg:space-y-6">
          ...
          >
            <TabsList className="h-full rounded-full bg-gray-300/20 px-2 py-2 ring-1 ring-gray-300/60 dark:bg-gray-100/10 dark:ring-gray-100/40">
              <TabsTrigger
                value="standard"
                className="w-[135px] rounded-full bg-background px-4 py-2 text-foreground data-[state=active]:bg-primary-800"
              >
                Standard
              </TabsTrigger>
              <TabsTrigger
                value="enterprise"
                className="ml-[6px] w-[135px] rounded-full bg-background px-4 py-2 text-foreground data-[state=active]:bg-primary-800"
              >
                Enterprise
              </TabsTrigger>
            </TabsList>
