...
const NavigationMenu = React.forwardRef(({ className, children, ...props }, ref) => (<NavigationMenuPrimitive.Root ref={ref} className={(0, utils_1.cn)("relative z-10 flex flex-1 items-center", className)} {...props}>
    {children}
...
const NavigationMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (<NavigationMenuPrimitive.Trigger ref={ref} className={(0, utils_1.cn)(navigationMenuTriggerStyle(), "group", className)} {...props}>
    {children}{" "}
    <react_icons_1.ChevronDownIcon className="relative top-0 ml-1 h-3 w-3 transition duration-300 group-data-[state=open]:rotate-180" aria-hidden="true"/>
