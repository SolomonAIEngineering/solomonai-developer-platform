...
exports.MerchantSeasonalTrendsChart = void 0;
...
const MerchantSeasonalTrendsChart = ({ merchants, xUNit, yUnit, currency, records, height, locale, enableAssistantMode, selectedSpendingPeriod, }) => {
    const [selectedMerchant, setSelectedMerchant] = (0, react_1.useState)(merchants[0] || "");
    if (!records || records.length === 0) {
        return null;
    }
    const allChartData = (0, react_1.useMemo)(() => {
        return (merchant_sub_profile_converter_1.MerchantFinancialMetricsConverter.identifySeasonalTrends(records, selectedSpendingPeriod) || []);
...
exports.MerchantSeasonalTrendsChart = MerchantSeasonalTrendsChart;
