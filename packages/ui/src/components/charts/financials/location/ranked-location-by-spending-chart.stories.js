...
const location_seasonal_trends_chart_1 = require("./location-seasonal-trends-chart");
const ranked_location_by_spending_chart_1 = require("./ranked-location-by-spending-chart");
/**
...
exports.default = {
    component: location_seasonal_trends_chart_1.LocationSeasonalTrendsChart,
    parameters: {
        layout: "centered",
    },
    argTypes: {
...
const Template = (args) => (<div className="w-[900px]">
    <ranked_location_by_spending_chart_1.RankedLocationsBySpendingChart {...args}/>
  </div>);
