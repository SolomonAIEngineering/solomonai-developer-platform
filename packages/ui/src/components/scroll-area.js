...
const ScrollArea = React.forwardRef(({ className, children, hideScrollbar, ...props }, ref) => (<ScrollAreaPrimitive.Root ref={ref} className={(0, utils_1.cn)("relative overflow-hidden", className)} {...props}>
...
const ScrollBar = React.forwardRef(({ className, orientation = "vertical", ...props }, ref) => (<ScrollAreaPrimitive.ScrollAreaScrollbar ref={ref} orientation={orientation} className={(0, utils_1.cn)("flex touch-none select-none transition-colors", orientation === "vertical" &&
    ...
    <ScrollAreaPrimitive.ScrollAreaThumb className={(0, utils_1.cn)("relative rounded-full bg-border", orientation === "vertical" && "flex-1")}/>
