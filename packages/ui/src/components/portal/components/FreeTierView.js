...
exports.FreeTierView = void 0;
const react_1 = __importDefault(require("react"));
const FreeTierView = ({ baseTierNumberOfConnectedAccounts, }) => (<div className="bg-background text-foreground">
...
exports.FreeTierView = FreeTierView;
