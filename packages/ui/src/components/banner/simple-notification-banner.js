...
exports.default = SimpleNotificationBanner;
 ...
 */
function SimpleNotificationBanner({ position = "bottom", centered = false, fullScreen = false, marginLeft = false, message, onSave, onReject, }) {
    const bannerClasses = (0, cn_1.cn)("pointer-events-none fixed inset-x-0 px-6 p-6 ring-1 ring-gray-900/10", {
    ...
    return (<div className={bannerClasses}>
      <card_1.Card className="pointer-events-auto max-w-xl rounded-2xl border-4 p-6 shadow-lg">
        ...
        <div className="mt-4 flex items-center gap-x-5">
          ...
          <button_1.Button variant="ghost" onClick={handleReject} className="text-sm font-semibold leading-6 text-gray-900">
            Reject
          </button_1.Button>
        </div>
      </card_1.Card>
