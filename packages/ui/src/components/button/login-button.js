 ...
 */
const LogInButton = ({ className, callBack }) => {
    return (<_1.Button className={(0, cn_1.cn)("rounded-2xl font-bold text-foreground", className)} variant="outline" onClick={callBack}>
      <outline_1.KeyIcon className="mr-2 h-5 w-5"/>
      Log In
    </_1.Button>);
};
