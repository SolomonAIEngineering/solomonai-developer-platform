...
exports.AccountBalanceConverter = void 0;
/**
...
class AccountBalanceConverter {
     ...
     * // ]
     */
    static convertToChartDataPoints(balanceHistory) {
        return balanceHistory.map((history) => {
            if (!history.time || history.balance === undefined) {
                throw new Error("AccountBalanceHistory object is missing required fields: time or balance");
            }
            return {
...
exports.AccountBalanceConverter = AccountBalanceConverter;
