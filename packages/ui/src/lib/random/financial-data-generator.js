...
exports.FinancialDataGenerator = void 0;
const client_typescript_sdk_1 = require("client-typescript-sdk");
const countries = ["US", "GB", "FR", "JP"];
class FinancialDataGenerator {
    static generateTransactionAggregatesArray = (numEntries, category, paymentChannel) => {
        const categories = [
            "Groceries",
            "Dining",
            "Transport",
        ...
        const profileTypes = Object.values(client_typescript_sdk_1.FinancialUserProfileType);
        const transactions = [];
     ...
     */
    static getRandomTransactionCategory() {
        const categories = [
            "Groceries",
            "Utilities",
            "Rent",
     ...
     */
    static getRandomDateObject(start, end) {
        const randomDate = new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));
        return randomDate;
    }
    /**
     ...
     */
    static getRandomStringWithPrefix(length, prefix = "") {
        const characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
        let result = "";
        for (let i = 0; i < length; i++) {
            result += characters.charAt(Math.floor(Math.random() * characters.length));
     ...
     */
    static generateRandomSettings() {
        return {
            id: FinancialDataGenerator.getRandomString(10),
            appTheme: client_typescript_sdk_1.ApplicationTheme.Dark,
            notificationSettings: {
                id: FinancialDataGenerator.getRandomString(10),
                notificationType: client_typescript_sdk_1.NotificationType.Email,
                alerts: FinancialDataGenerator.getRandomBoolean(),
            },
            preferredLanguage: FinancialDataGenerator.getRandomString(10),
            riskTolerance: client_typescript_sdk_1.RiskToleranceSettings.Low,
     ...
     *   object.
     */
    static generateFinancialProfile() {
        return {
            id: FinancialDataGenerator.getRandomString(10),
            ...
            profileType: client_typescript_sdk_1.FinancialUserProfileType.User,
     ...
     *   object.
     */
    static generateFinancialContext() {
        return {
            categories: [],
            expenses: [],
            income: [],
            ...
            merchants: [],
            paymentChannels: [],
            investmentAccounts: FinancialDataGenerator.generateRandomInvestmentAccounts(2),
            ...
            studentLoanAccounts: FinancialDataGenerator.generateRandomStudentLoanAccounts(5),
            financialUserProfileType: client_typescript_sdk_1.FinancialUserProfileType.User,
        };
    }
    /**
     ...
     */
    static generateRandomUserAccount() {
        return {
            accountType: client_typescript_sdk_1.ProfileType.User,
            ...
            createdAt: FinancialDataGenerator.getRandomDateObject(new Date(2020, 0, 1), new Date()),
            email: FinancialDataGenerator.getRandomString(10),
            ...
            verifiedAt: FinancialDataGenerator.getRandomDateObject(new Date(2020, 0, 1), new Date()),
     ...
     *   object.
     */
    static generateAccountBalanceHistory() {
        return {
            ...
            isoCurrencyCode: ["USD", "EUR", "GBP", "JPY", "AUD"][FinancialDataGenerator.getRandomNumber(0, 4)],
     ...
     */
    static generateRandomAccountBalanceHistoryList(count) {
        const accountBalanceHistoryList = [];
        for (let i = 0; i < count; i++) {
            accountBalanceHistoryList.push(FinancialDataGenerator.generateAccountBalanceHistory());
        }
    ...
    static generateBudget() {
        return {
            ...
            name: FinancialDataGenerator.getRandomString(5),
            description: FinancialDataGenerator.getRandomString(10),
            startDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            endDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
    ...
    static generateMilestone() {
        return {
            ...
            name: FinancialDataGenerator.getRandomString(5),
            description: FinancialDataGenerator.getRandomString(10),
            targetDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
    ...
    static generateForecast() {
        return {
            ...
            forecastedCompletionDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
    ...
    static generateSmartGoal() {
        ...
        const milestones = Array.from({ length: numberOfMilestones }, () => FinancialDataGenerator.generateMilestone());
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            ...
            startDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            endDate: FinancialDataGenerator.getRandomDate(new Date(2022, 0, 1), new Date(2030, 0, 1)),
    ...
    static generatePocket() {
        ...
        const goals = Array.from({ length: numberOfGoals }, () => FinancialDataGenerator.generateSmartGoal());
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            goals: goals,
     ...
     * @returns {BankAccount}
     * */
    static generateRandomBankAccount() {
        const numberOfPocketsToGenerate = FinancialDataGenerator.getRandomNumber(0, 5); // Assuming a random number of goals between 0 to 5 for each pocket
        const pockets = Array.from({ length: numberOfPocketsToGenerate }, () => FinancialDataGenerator.generatePocket());
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            userId: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            ...
            type: client_typescript_sdk_1.BankAccountType.Plaid,
            ...
            status: client_typescript_sdk_1.BankAccountStatus.Active,
            transactions: [],
     ...
     * @returns {BankAccount[]}
     */
    static generateRandomBankAccounts = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomBankAccount);
    };
    ...
    static getTrulyRandomString = () => Math.random().toString(36).substring(2, 15);
    // Mock data for currencies and countries for more realistic mock data
    static getRandomFromArray = (arr) => arr[Math.floor(Math.random() * arr.length)];
    static getRandomCountry = () => FinancialDataGenerator.getRandomFromArray(countries);
    ...
    static generateRandomTransaction = () => ({
        ...
        personalFinanceCategoryPrimary: FinancialDataGenerator.generatePrimaryCategory(),
        personalFinanceCategoryDetailed: FinancialDataGenerator.generatePrimaryCategory(),
        ...
        profileType: FinancialDataGenerator.getRandomBoolean()
            ? client_typescript_sdk_1.FinancialUserProfileType.User
            : client_typescript_sdk_1.FinancialUserProfileType.Business, // Example if FinancialUserProfileType is an enum or union type
    });
    /**
     ...
     * }}
     */
    static generateRandomTransactionSplit = () => {
        return {
            ...
            personalFinanceCategoryPrimary: FinancialDataGenerator.getRandomString(10),
            personalFinanceCategoryDetailed: FinancialDataGenerator.getRandomString(10),
            tags: [
                FinancialDataGenerator.getRandomString(10),
                FinancialDataGenerator.getRandomString(10),
            ],
     ...
     */
    static generateRandomTransactionSplits = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomTransactionSplit);
    };
    /**
     ...
     * @returns {string[]}
     */
    static generateRandomCategories = (count) => {
        const categories = [
            "Groceries",
            "Utilities",
            "Rent",
        ...
        return Array.from({ length: count }, () => FinancialDataGenerator.getRandomFromArray(categories));
    };
    // Function to generate an array of random Transaction objects
    static generateRandomTransactions = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomTransaction);
    };
    /**
     ...
     * @returns {string}
     */
    static generatePrimaryCategory = () => {
        const categories = [
            "dining",
            "transportation",
            "entertainment",
     ...
     * @returns {string}
     */
    static generatePaymentChannels = () => {
     ...
     */
    static generateRandomPlaidAccountTransactions = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomPlaidAccountTransaction);
    };
    /**
     ...
     *   balance history.
     */
    static generateRandomAccountBalanceHistory = () => {
        return {
            id: FinancialDataGenerator.getRandomStringWithPrefix(5, "BAL-"),
            time: FinancialDataGenerator.getRandomDateInRange(new Date(2020, 0, 1).getTime(), new Date(2023, 11, 31).getTime()),
            accountId: FinancialDataGenerator.getRandomStringWithPrefix(5, "ACC-"),
            isoCurrencyCode: ["USD", "EUR", "GBP", "JPY", "AUD"][FinancialDataGenerator.getRandomNumber(0, 4)],
            balance: FinancialDataGenerator.getRandomBalance(),
            userId: FinancialDataGenerator.getRandomString(10),
     ...
     *   objects.
     */
    static generateRandomAccountBalanceHistories = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomAccountBalanceHistory);
    };
    static generateRandomMonthlyBalances = (count) => {
        const balances = [];
        for (let i = 0; i < count; i++) {
            balances.push({
     ...
     *   object.
     */
    static generateRandomStudentLoanAccount = () => {
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            plaidAccountId: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            disbursementDates: ["2028-01-01", "2028-02-01"],
            expectedPayoffDate: "2028-01-01",
            guarantor: "US Department of Education",
            interestRatePercentage: (FinancialDataGenerator.getRandomNumber(0, 1) * 1) /
            ...
            pslfStatusPaymentsRemaining: FinancialDataGenerator.getRandomNumber(1, 100),
     ...
     */
    static generateRandomStudentLoanAccounts = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomStudentLoanAccount);
    };
    static generateRandomIncomeMetrics = (count, year) => {
        const incomeMetrics = [];
        for (let i = 0; i < count; i++) {
            ...
            incomeMetrics.push({
                ...
                personalFinanceCategoryPrimary: FinancialDataGenerator.getRandomTransactionCategory(),
     ...
     *   month.
     */
    static generateRandomExpenseMetrics = (count, year) => {
     ...
     */
    static generateRandomSmartNote = () => {
        return {
            id: FinancialDataGenerator.getRandomString(10),
            userId: FinancialDataGenerator.getRandomString(10),
     ...
     */
    static generateRandomSmartNotes = (count) => {
        return Array.from({ length: count }, FinancialDataGenerator.generateRandomSmartNote);
    };
    /**
     ...
     */
    static generateRandomMerchantMonthlyExpenditures = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateRandomUserCategoryMonthlyExpenditures = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateMonthlyExpenditures = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generatePaymentChannelMonthlyExpenditures = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     *   objects.
     */
    static generateIncomeMetrics = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
                ...
                totalIncome: FinancialDataGenerator.getRandomNumber(1, 10000),
                personalFinanceCategoryPrimary: FinancialDataGenerator.getRandomTransactionCategory(),
                transactionCount: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
                userId: FinancialDataGenerator.getRandomString(10),
                profileType: client_typescript_sdk_1.FinancialUserProfileType.User,
            });
        }
     ...
     */
    static generateIncomeMetricsAcrossManyYears(startYear, endYear) {
        const sampleData = [];
        const categories = [
            "Salary",
            "Investments",
     ...
     * @returns An array of IncomeMetrics
     */
    static generateExpenseMetricsAcrossManyYears(startYear, endYear) {
        const sampleData = [];
        const categories = [
            "Salary",
            "Investments",
     ...
     *   objects.
     */
    static generateMonthlyIncome = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateUserCategoryMonthlyIncome = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateUserCategoryMonthlyData = (count, year, type) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            const baseData = {
     ...
     *   month.
     */
    static generateRandomPaymentChannelMetricsFinancialSubProfile = (count) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateRandomMerchantMetricsFinancialSubProfile = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateRandomLocationMetricsFinancialSubProfile = (count, year) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateRandomIncomeMetricsFinancialSubProfile = (count) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     */
    static generateRandomExpenseMetricsFinancialSubProfile = (count) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
                ...
                spentLastMonth: FinancialDataGenerator.getRandomNumber(1, 10000),
                spentLastSixMonths: FinancialDataGenerator.getRandomNumber(1, 10000),
                averageMonthlyDiscretionarySpending: FinancialDataGenerator.getRandomNumber(1, 10000),
                averageMonthlyRecurringSpending: FinancialDataGenerator.getRandomNumber(1, 10000),
                userId: FinancialDataGenerator.getRandomString(10),
                profileType: client_typescript_sdk_1.FinancialUserProfileType.User,
            });
        }
     ...
     */
    static generateRandomCategoryMetricsFinancialSubProfile = (count) => {
        const metrics = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
            metrics.push({
     ...
     *   object.
     */
    static generateRandomFinancialContext = () => {
        // Add your code here to generate and return a FinancialUserProfile
        return {
            // Add properties and values for the FinancialUserProfile
            categories: FinancialDataGenerator.generateRandomCategoryMetricsFinancialSubProfile(5),
            expenses: FinancialDataGenerator.generateRandomExpenseMetricsFinancialSubProfile(5),
            income: FinancialDataGenerator.generateRandomIncomeMetricsFinancialSubProfile(5),
            locations: FinancialDataGenerator.generateRandomLocationMetricsFinancialSubProfile(5, 2023),
            merchants: FinancialDataGenerator.generateRandomMerchantMetricsFinancialSubProfile(5, 2023),
            paymentChannels: FinancialDataGenerator.generateRandomPaymentChannelMetricsFinancialSubProfile(5),
            bankAccounts: FinancialDataGenerator.generateRandomBankAccounts(5),
            investmentAccounts: FinancialDataGenerator.generateRandomInvestmentAccounts(5),
     ...
     */
    static generateDebtToIncomeRatios = (count, year) => {
        const debtToIncomeRatios = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
     ...
     *   random values for the properties.
     */
    static generateIncomeExpenseRatios = (count, year) => {
        const incomeExpenseRatios = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
     ...
     *   properties.
     */
    static generateCategoryMonthlyTransactionCounts = (count, year) => {
        const categoryMonthlyTransactionCounts = [];
        for (let i = 0; i < count; i++) {
            const month = FinancialDataGenerator.getRandomNumber(1, 12);
     ...
     */
    static generateMonthlyTransactionCounts = (count, year) => {
     ...
     *   data.
     */
    static generateMonthlySavings = (count, year) => {
     ...
     */
    static generateRandomInvestmentHolding = () => {
        return {
     ...
     *   holdings.
     */
    static generateRandomInvestmentHoldings = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomInvestmentHolding());
    };
    /**
     ...
     */
    static generateRandomInvestmentSecurity = () => {
        return {
     ...
     *   securities.
     */
    static generateRandomInvestmentSecurities = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomInvestmentSecurity());
    };
    /**
     ...
     */
    static generateRandomInvestmentAccount = () => {
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 100).toString(),
     ...
     *   accounts.
     */
    static generateRandomInvestmentAccounts = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomInvestmentAccount());
    };
    /**
     ...
     */
    static generateRandomBudgets = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomBudget());
    };
    static generateRandomMilestone = () => {
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            name: FinancialDataGenerator.getRandomString(5),
            description: FinancialDataGenerator.getRandomString(10),
     ...
     */
    static generateRandomMilestones = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomMilestone());
    };
    /**
     ...
     */
    static generateRandomGoals = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomGoal());
    };
    /**
     ...
     */
    static generateRandomPockets = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomPocket());
    };
    /**
     ...
     */
    static generateRandomCreditAccount = () => {
        return {
            id: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            userId: FinancialDataGenerator.getRandomNumber(1, 10000).toString(),
            name: `Account ${FinancialDataGenerator.getRandomString(5)}`,
            ...
            lastPaymentDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            nextPaymentAmount: FinancialDataGenerator.getRandomNumber(100, 1000),
            nextPaymentDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            lastStatementIssueDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            ...
            nextPaymentDueDate: FinancialDataGenerator.getRandomDate(new Date(2020, 0, 1), new Date(2025, 0, 1)),
            status: client_typescript_sdk_1.BankAccountStatus.Active,
        };
    };
    /**
     ...
     *   objects.
     */
    static generateRandomCreditAccounts = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomCreditAccount());
    };
    /**
     ...
     */
    static generateRandomPlaidAccountRecurringTransaction() {
        return {
            accountId: FinancialDataGenerator.getRandomString(10),
     ...
     */
    static generateRandomPlaidAccountRecurringTransactions = (count) => {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomPlaidAccountRecurringTransaction());
    };
    /**
     ...
     */
    static generateRandomLinks(count) {
        return Array.from({ length: count }, () => FinancialDataGenerator.generateRandomLink());
    }
    /**
     ...
     */
    static getRandomDateInRange(startTimestamp, endTimestamp) {
    ...
    static getNumberOfGoals = (account) => {
    ...
    static getNumberMilestones = (account) => {
        // iterate over all pockets and sum the number of milestones
        return account.pockets?.reduce((acc, pocket) => {
            return (acc +
                (pocket.goals?.reduce((acc, goal) => acc + (goal.milestones?.length ?? 0), 0) ?? 0));
        }, 0);
    };
}
exports.FinancialDataGenerator = FinancialDataGenerator;
