 ...
 */
export function stripSpecialCharacters(inputString: string): string {
...
type FileTypeValues = (typeof FileType)[keyof typeof FileType];
 ...
 */
export function isSupportedFilePreview(type: FileTypeValues | string): boolean {
  if (!type) {
    return false;
  }
