...
export const ColumnsMenu = ({ editor, appendTo }) => {
    ...
    return (<BaseBubbleMenu editor={editor} pluginKey={`columnsMenu-${uuid()}`} shouldShow={shouldShow} updateDelay={0} tippyOptions={{
            offset: [0, 8],
            popperOptions: {
      ...
      <Toolbar.Wrapper>
        <Toolbar.Button tooltip='Sidebar left' active={editor.isActive('columns', {
            layout: ColumnLayout.SidebarLeft,
        })} onClick={onColumnLeft}>
          <Icon name='PanelLeft'/>
        </Toolbar.Button>
        <Toolbar.Button tooltip='Two columns' active={editor.isActive('columns', {
            layout: ColumnLayout.TwoColumn,
        })} onClick={onColumnTwo}>
          <Icon name='Columns'/>
        </Toolbar.Button>
        <Toolbar.Button tooltip='Sidebar right' active={editor.isActive('columns', {
