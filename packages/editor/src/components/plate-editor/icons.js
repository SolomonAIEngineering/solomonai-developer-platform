...
import { AlignCenter, AlignJustify, AlignLeft, AlignRight, Baseline, Bold, Check, ChevronDown, ChevronRight, ChevronsUpDown, Code2, Combine, Edit2, ExternalLink, Eye, FileCode, GripVertical, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6, Image, Indent, Italic, Keyboard, Link2, Link2Off, List, ListOrdered, MessageSquare, MessageSquarePlus, Minus, Moon, MoreHorizontal, Outdent, PaintBucket, Pilcrow, Plus, Quote, RectangleHorizontal, RectangleVertical, RotateCcw, Search, Settings, Smile, Strikethrough, Subscript, SunMedium, Superscript, Table, Text, Trash, Twitter, Underline, Ungroup, WrapText, X, } from 'lucide-react';
const borderAll = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
const borderBottom = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
const borderLeft = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
const borderNone = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
const borderRight = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
const borderTop = (props) => (<svg viewBox='0 0 24 24' height='48' width='48' focusable='false' role='img' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
...
export const Icons = {
    ...
    viewing: Eye,
    // www
    gitHub: (props) => (<svg viewBox='0 0 438.549 438.549' {...props}>
    ...
    logo: (props) => (<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' {...props}>
