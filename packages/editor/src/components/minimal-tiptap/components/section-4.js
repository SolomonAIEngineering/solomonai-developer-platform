    ...
    return (<>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <ToolbarButton isActive={editor.isActive('codeBlock') || editor.isActive('blockquote')} tooltip='Insert elements' className='w-12'>
            <PlusIcon className='size-5'/>
            <CaretDownIcon className='size-5'/>
          </ToolbarButton>
        </DropdownMenuTrigger>
        <DropdownMenuContent align='start' className='w-full'>
          <DropdownMenuItem onClick={() => editor.chain().focus().toggleCodeBlock().run()} className={cn(DropdownMenuItemClass, {
          ...
          <DropdownMenuItem onClick={() => editor.chain().focus().toggleBlockquote().run()} className={cn(DropdownMenuItemClass, {
