...
export default function SectionOne({ editor }) {
    ...
    return (<DropdownMenu>
      <DropdownMenuTrigger asChild>
        <ToolbarButton isActive={editor.isActive('heading')} tooltip='Text styles' className='w-12' disabled={editor.isActive('codeBlock')}>
          <LetterCaseCapitalizeIcon className='size-5'/>
          <CaretDownIcon className='size-5'/>
        </ToolbarButton>
      </DropdownMenuTrigger>
      <DropdownMenuContent align='start' className='w-full'>
        <DropdownMenuItem onClick={() => editor.chain().focus().setParagraph().run()} className={cn(DropdownMenuItemClass, {
            [activeItemClass]: editor.isActive('paragraph'),
        })} aria-label='Normal text'>
          <span className='grow'>Normal Text</span>
          <ShortcutKey keys={['mod', 'alt', '0']}/>
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => toggleHeading(1)} className={cn(DropdownMenuItemClass, {
        ...
        <DropdownMenuItem onClick={() => toggleHeading(2)} className={cn(DropdownMenuItemClass, {
        ...
        <DropdownMenuItem onClick={() => toggleHeading(3)} className={cn(DropdownMenuItemClass, {
        ...
        <DropdownMenuItem onClick={() => toggleHeading(4)} className={cn(DropdownMenuItemClass, {
        ...
        <DropdownMenuItem onClick={() => toggleHeading(5)} className={cn(DropdownMenuItemClass, {
        ...
        <DropdownMenuItem onClick={() => toggleHeading(6)} className={cn(DropdownMenuItemClass, {
