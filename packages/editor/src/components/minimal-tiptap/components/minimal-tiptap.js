...
const MinimalTiptapEditor = forwardRef(({ value, outputValue = 'html', disabled, contentClass, onValueChange, className, ...props }, ref) => {
    ...
    return (<div className={cn('flex h-auto min-h-72 w-full flex-col rounded-md border border-input shadow-sm focus-within:border-primary', className)} {...props} ref={ref}>
        {editor && (<>
