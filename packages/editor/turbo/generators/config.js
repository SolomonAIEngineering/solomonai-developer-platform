    ...
    plop.setGenerator("react-component", {
        ...
        actions: [
            ...
            },
            {
                ...
                template: "export * from './components/{{pascalCase name}}/{{pascalCase name}}';\n",
            },
            {
                type: "append",
                path: "package.json",
                pattern: /"exports": {(?<insertion>)/g,
                template: '"./src/components/{{kebabCase name}}/{{kebabCase name}}.tsx": "./src/components/{{kebabCase name}}/{{kebabCase name}}.tsx",\n',
            },
        ],
    });
    ...
    plop.setGenerator("react-hook", {
        ...
        actions: [
            ...
            },
            {
                type: "append",
                path: "src/index.ts", // Assuming you have an index file for barrel exports
                template: "export * from './hooks/{{kebabCase name}}/{{kebabCase name}}';\n",
            },
        ],
    });
}
