...
function Footer({ baseUrl }) {
  return (
    <components_1.Section className='w-full'>
      <components_1.Hr />
      ...
      <responsive_react_email_1.TripleColumn
        pX={0}
        pY={0}
        ...
        columnOneContent={
          <components_1.Section className='m-0 p-0 text-left'>
            <components_1.Row>
              <components_1.Text className='font-medium'>
                Features
              </components_1.Text>
            </components_1.Row>
      ...
      <components_1.Row>
        <components_1.Text className='text-xs text-[#B8B8B8]'>
          Solomon AI
        </components_1.Text>
      </components_1.Row>
