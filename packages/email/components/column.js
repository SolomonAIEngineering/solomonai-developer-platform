...
function Column({ title, description, footer, imgSrc }) {
    return (<components_1.Section className='m-0 p-0 text-left'>
      ...
      <components_1.Section className='box-border inline-block w-[280px] w-full text-left align-top'>
        <components_1.Section className='m-0 p-0 text-left'>
          <components_1.Text className='m-0 mb-2 pt-0 font-medium'>{title}</components_1.Text>
          <components_1.Text className='m-0 p-0 text-[#707070]'>{description}</components_1.Text>
          <components_1.Text className='mt-2 p-0 text-[#707070]'>{footer}</components_1.Text>
        </components_1.Section>
      </components_1.Section>
    </components_1.Section>);
}
