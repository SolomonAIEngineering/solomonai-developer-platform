...
const ConnectionExpireEmail = ({
  fullName = 'Yoan Yomba',
  expiresAt = (0, date_fns_1.addDays)(new Date(), 4).toISOString(),
  bankName = 'Revolut',
  teamName = 'Solomon AI',
}) => {
        ...
        <components_1.Body className='mx-auto my-auto bg-[#fff] font-sans'>
          ...
          >
            ...
            <components_1.Text className='text-[#121212]'>
              ...
              {(0, date_fns_1.formatDistance)(new Date(expiresAt), new Date())}.
              To ensure that Solomon AI continues to run smoothly, please
              reconnect your bank.
              <br />
              <br />
