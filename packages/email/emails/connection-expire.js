...
const ConnectionExpireEmail = ({ fullName = 'Yoan Yomba', expiresAt = (0, date_fns_1.addDays)(new Date(), 4).toISOString(), bankName = 'Revolut', teamName = 'Solomon AI', }) => {
        ...
        <components_1.Body className='mx-auto my-auto bg-[#fff] font-sans'>
          <components_1.Container className='mx-auto my-[40px] max-w-[600px] border-transparent p-[20px] md:border-[#E8E7E1]' style={{ borderStyle: 'solid', borderWidth: 1 }}>
            ...
            <components_1.Section className='mb-[50px] mt-[50px] text-center'>
              <components_1.Button className='rounded-md border border-solid border-[#121212] bg-transparent px-6 py-3 text-center text-[14px] font-medium text-[#121212] text-primary no-underline' href='https://solomon-ai.app/'>
                Reconnect
              </components_1.Button>
