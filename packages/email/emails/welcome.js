        ...
        <components_1.Body className='mx-auto my-auto bg-[#fff] font-sans'>
          <components_1.Container className='mx-auto my-[40px] max-w-[600px] border-transparent p-[20px] md:border-[#E8E7E1]' style={{ borderStyle: 'solid', borderWidth: 1 }}>
            ...
            <components_1.Text className='text-[#121212]'>
              ...
              <components_1.Link href='https://cal.com/solomonai/15min' className='text-[#121212] underline'>
            ...
            <components_1.Img src={`${baseUrl}/founders.jpeg`} alt='Founders' className='mx-auto my-0 block w-full'/>
