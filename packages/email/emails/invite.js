...
const baseAppUrl = process.env.VERCEL_ENV === 'production'
    ...
    : 'http://localhost:3001';
const InviteEmail = ({ invitedByEmail = 'bukinoshita@example.com', invitedByName = 'Yoan Yomba', email = 'yoanyomba@solomon-ai.co', teamName = 'Acme Co', inviteCode = 'jnwe9203frnwefl239jweflasn1230oqef', ip = '204.13.186.218', location = 'São Paulo, Brazil', locale = 'en', }) => {
        ...
        <components_1.Body className='mx-auto my-auto bg-[#fff] font-sans'>
          <components_1.Container className='mx-auto my-[40px] max-w-[600px] border-transparent p-[20px] md:border-[#E8E7E1]' style={{ borderStyle: 'solid', borderWidth: 1 }}>
            ...
            <components_1.Section className='mb-[42px] mt-[32px] text-center'>
              <components_1.Button className='rounded-md border border-solid border-[#121212] bg-transparent px-6 py-3 text-center text-[14px] font-medium text-[#121212] text-primary no-underline' href={inviteLink}>
                {t('invite.join')}
              </components_1.Button>
