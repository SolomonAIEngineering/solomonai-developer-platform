...
exports.Prisma.Smart_notesScalarFieldEnum = {
  ...
  embedding_error: 'embedding_error',
  last_embedded_at: 'last_embedded_at',
  plaid_account_investment_transaction_id: 'plaid_account_investment_transaction_id',
  plaid_account_recurring_transaction_id: 'plaid_account_recurring_transaction_id',
...
exports.Prisma.Student_loan_accountsScalarFieldEnum = {
  ...
  plaid_account_id: 'plaid_account_id',
  pslf_status_estimated_eligibility_date: 'pslf_status_estimated_eligibility_date',
...
exports.Prisma.Report_itemsScalarFieldEnum = {
  ...
  financing_activities_cash_flow_statements_id: 'financing_activities_cash_flow_statements_id',
  id: 'id',
  income_income_statement_id: 'income_income_statement_id',
  investing_activities_cash_flow_statements_id: 'investing_activities_cash_flow_statements_id',
  liabilities_balance_sheet_id: 'liabilities_balance_sheet_id',
  modified_at: 'modified_at',
  name: 'name',
  non_operating_expenses_income_statement_id: 'non_operating_expenses_income_statement_id',
  operating_activities_cash_flow_statements_id: 'operating_activities_cash_flow_statements_id',
  operating_expenses_income_statement_id: 'operating_expenses_income_statement_id',
  remote_id: 'remote_id',
  value: 'value'
};
