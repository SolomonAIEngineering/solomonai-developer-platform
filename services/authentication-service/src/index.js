...
const setSupabaseClients_mw_1 = __importDefault(
  require("./middlewares/setSupabaseClients.mw"),
);
...
app.post(
  "/auth/logout",
  (0, auth_mw_1.default)(auth_types_1.AuthRoles.Any),
  auth_controller_1.default.logout,
); // Logout user
app.get(
  "/auth/check-session",
  (0, auth_mw_1.default)(auth_types_1.AuthRoles.Any),
  auth_controller_1.default.checkSession,
...
app.post(
  ...
  auth_controller_1.default.initializeSession,
); // Inıtialize session with supabase tokens
