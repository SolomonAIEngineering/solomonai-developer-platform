...
async function findAndReplacePackageNames() {
  ...
  await (0, utils_1.traverseDirectory)(
    process.cwd(),
    async (fullPath) => {
  ...
  await (0, utils_1.updateNamespaceInPrettierConfig)(
    process.cwd(),
    newNamespace,
  );
}
...
void (0, utils_1.updateWorkspacePackages)(
  process.cwd(),
...
if (newNamespace) {
  ...
  (0, utils_1.updateWorkspacePackages)(
    process.cwd(),
    updateDependencies,
    includeRoot,
  )
